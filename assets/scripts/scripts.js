function enviarConfirmacion() {
  Swal.fire({
    ...
    text: "Estamos emocionados de contar con usted en nuestro día especial. ¡Nos vemos pronto!",
    icon: "success",
    // ANIMACIONES AQUÍ:
    showClass: {
    ...
    if (result.isConfirmed) {
      emailjs
        .send("service_7z4jaug", "template_vtyjaje", {
          to_name:
            "Nombre de invitados: Serenia - Confirmado para 01 personas",
          from_name: "Invitado Confirmado",
          message: "Serenia - Confirmado para 02 personas",
        })
        .then(
          function (response) {
            console.log(
